namespace newsletter_form_api.Models.Results
{
    ...
    public class Result<T> : Result
    {
        ...
        public static Result<T> ValidationError(string error) => new(false, error, default, ErrorType.Validation);
        public static Result<T> NotFound(string error) => new(false, error, default, ErrorType.NotFound);
        public static Result<T> Conflict(string error) => new(false, error, default, ErrorType.Conflict);
    }
}